...
Route::get('getcampaigns/{userid}', 'Campaign\CampaignController@show');
Route::get('getsenders/{userid}', 'Campaign\SenderController@show');
Route::get('getcampaign/{userid}/{campaign_id}', 'Campaign\CampaignController@showbyid');
Route::get('bill/{campaign_id}/{user_id}', 'Campaign\MessageController@calculaterate');
Route::get('delivery', 'Campaign\MessageController@getreport');
